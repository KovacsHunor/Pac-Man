...
void field(color c)
{
  ...
  stroke(c);
   ...
   walls[44].Show(26, 17, 3, 1, 0);
  walls[45].Show(26, 19, 3, 1, 0);
  walls[42].Show(-1, 17, 3, 1, 0);
  walls[43].Show(-1, 19, 3, 1, 0);
  
  noStroke();
  rect(-1*25, 17*25, 3*25, 1*25);
  rect(-1*25, 19*25, 3*25, 1*25);
  rect(26*25, 17*25, 3*25, 1*25);
  rect(26*25, 19*25, 3*25, 1*25);
  stroke(c);
